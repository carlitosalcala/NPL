...
*----------------------------------------------------------------------
*  Title:
*    Objects 304: Design Patterns: Factory method pattern, step 1
...
*   This version illustrates the "factory method" design pattern.
*   To reiterate, there actually are 3 different variations of the
*   factory pattern:
*     o Simple factory
*     o Factory method
*     o Abstract factory
*   The design pattern we are using here with the new class
*   "navigation_accessories_maker" and its inheriting subclasses
*   represents a "Factory method" pattern.  The significant
*   characteristic of the Factory method pattern is that a subclass
*   determines the actual type of object to be instantiated.
*
*   The following new classes have been added to demonstrate the
*   "Factory method" design pattern.
*      o "navigation_accessories_maker"
*      o   "dead_reckoning_unit_maker"
*      o   "navigator_unit_maker"
*      o   "gps_unit_maker"
*      o "vehicle_accessories_store"
*
*   Class "navigation_accessories_maker" is defined with protected
*   methods to handle calibrating and registering a navigation unit,
*   but its "create_unit" method is defined as abstract, meaning that
*   it must be implemented in a subclass.  Accordingly, the methods for
*   calibrating and registering the navigation unit are unaware
*   of the type of navigation unit with which they are working.
*   It provides public method "make_navigation_unit" for callers to
*   invoke for having a navigation unit created.
*
*   Classes "dead_reckoning_unit_maker", "navigator_unit_maker" and
*   "gps_unit_maker" all inherit from "navigation_accessories_maker"
*   with each one redefining the abstract method "create_unit"
*   defined by the superclass.  Their corresponding implementations
*   for method "create_unit" facilitate creating a navigation unit
*   of whichever type is the associated specialty.  With class
*   "gps_unit_maker", it also redefines the public method
*   "make_navigation_unit" so that it can include a call to its
*   own private method "download_software_to_unit" in addition to
*   calling the superclass methods for calibration and registration.
*
*   Class "vehicle_accessories_store" is defined as a static class
*   with public method "get_navigation_unit", which accepts the
*   checkbox flags indicating which type of navigation unit is
*   selected along with the initial heading, and passes back to
*   the caller a navigation unit and its type.  It has 3 private
*   attributes for references to "dead_reckoning_unit_maker",
*   "navigator_unit_maker" and "gps_unit_maker" instances.  Its
*   implementation of "get_navigation_unit" identifies the type
*   of navigation unit requested, insures that it has a valid
*   reference to the corresponding unit maker, and then invokes
*   that unit maker to create an instance of a navigation unit.
*
*   Class "vehicle" is changed so that its constructor method
*   no longer contains a "create object" statement for creating
*   instances of navigation units.  Instead, it calls method
*   "get_navigation_unit" of class "vehicle_accessories_store" to
*   have these instances created for it.
*
...
*       the shop which produces basic navigator units:
      ...
      when gps_navigation.
*       We want a gps unit.  Make certain we have access to
*       the shop which produces gps units:
