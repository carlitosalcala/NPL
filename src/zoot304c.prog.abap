...
*----------------------------------------------------------------------
*  Title:
*    Objects 304: Design Patterns: Factory method pattern, step 2
...
*
*   New navigation unit class "commercial_gps" is defined as a nearly
*   identical copy of class "gps", with changes to the corresponding
*   class id in its definition and references to its own class in its
*   implementation.
*
*   New navigation unit maker class "commercial_gps_unit_maker" is a
*   nearly identical copy of class "gps_unit_maker", with changes to
*   its own class in its implementation.  It includes additional
*   method "download_bridge_data_to_unit", not found in class
*   "gps_unit_maker", which issues an informational message that
*   the unit has been loaded with bridge data, providing the user
*   information on bridges with low overhead clearances and weight
*   restrictions, information which is applicable primarily to
*   commercial drivers to ensure safety.  This new method is invoked
*   in the redefined implementation of method "make_navigation_unit"
*   prior to invoking the method to register the unit.
*
*   Class "vehicle_accessories_store" is changed to retain an object
*   reference to an instance of "commercial_gps_unit_maker".  Its
*   method "get_navigation_unit" is changed to accept a parameter
*   indicating the classification of the vehicle to receive the new
*   unit, and when the vehicle classification indicates a truck,
*   a request for a gps unit will return a commercial gps unit.
*
*   Class "vehicle" is changed so that its constructor method now
*   accepts and passes on to called method "get_navigation_unit"
*   of class "vehicle_accessories_store" the classification
*   of the corresponding vehicle: "car" or "truck".
*
*   Classes "car" and "truck" each now define an attribute for the type
*   of class it is, using this value to send its vehicle classification
*   (its class id) on the call to the super constructor.
*
